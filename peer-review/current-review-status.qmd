...
```{python}
presub_path = data_path = Path.cwd().parents[0] / "data" /  "review_presubmissions.csv"
...
editor_data["gh_username"] = (
    editor_data["gh_username"].astype(str).str.strip().str.lower()
)
...
editor_keys = open_reviews["editor"].astype(str).str.split().str[0].str.lower()
busy_editors = (
    editor_keys[editor_keys != "tbd"]
    .value_counts()
    .rename_axis("editor")
